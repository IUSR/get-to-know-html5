...
demos.crank.initWorld = function(world) {
	...
	bd.position.Set(width/2, 210);
	var body = world.CreateBody(bd);

	rjd.anchorPoint.Set(width/2, 235);
	rjd.body1 = prevBody;
	rjd.body2 = body;
	...
	// Define follower.
	sd.extents.Set(5, 45);
	bd.position.Set(width/2, 140);
	body = world.CreateBody(bd);

	rjd.anchorPoint.Set(width/2, 185);
	rjd.body1 = prevBody;
	rjd.body2 = body;
	...
	bd.position.Set(width/2, 95);
	body = world.CreateBody(bd);

	rjd.anchorPoint.Set(width/2, 95);
	rjd.body1 = prevBody;
	rjd.body2 = body;
	world.CreateJoint(rjd);

	var pjd = new b2PrismaticJointDef();
	pjd.anchorPoint.Set(width/2, 95);
	pjd.body1 = ground;
	pjd.body2 = body;
